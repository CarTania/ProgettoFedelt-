...
public class ProgrammaPuntiTest {
    ...
    public void costruzioneProgrammaConCatalogo() {
        ...
        ProgrammaPunti p1 =
            new ProgrammaPunti(LocalDate.of(2023, 5, 24), 0.5, c);

        assertNotNull(p1);
        assertTrue(p1.getCatalogoOpzionale().isPresent());
        assertThrows(IllegalArgumentException.class, () -> {
            new ProgrammaPunti(LocalDate.of(2023, 5, 24), 0, c);
        });
    }
    ...
    public void costruzioneProgrammaSenzaCatalogo() {
        ProgrammaPunti p1 =
            new ProgrammaPunti(LocalDate.of(2023, 5, 24), 0.5);

        assertNotNull(p1);
        assertThrows(IllegalArgumentException.class, () -> {
            new ProgrammaPunti(LocalDate.of(2023, 5, 24), 0);
        });
    }
    ...
    public void premiRiscattabiliClienteTest() {
        ...
        List<Premio> premiRiscattabili1 =
    ...
    public void riscattoPremioCatalogoTest() {
        ...
        Optional<Premio> premioOttenuto = p1.riscattoPremioCatalogo(cliente, premio);

        assertTrue(premioOttenuto.isPresent());
        assertEquals("Chitarra elettrica", premioOttenuto.get().getPremio().getNome());
    ...
    public void generaCouponTest() {
        ...
        assertEquals(20, coupon.getTotaleSconto());
