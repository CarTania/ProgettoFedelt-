...
/**
 * Precompiled it.unicam.ids.dharma.java-application-conventions script plugin.
 **/
public class ItUnicamIdsDharmaJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ItUnicamIdsDharmaJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("it.unicam.ids.dharma.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ItUnicamIdsDharmaJavaApplicationConventions").asSubclass(BasicScript.class);
